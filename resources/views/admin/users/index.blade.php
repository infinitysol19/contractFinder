...
<div class="main-container">
  <div class="xs-pd-20-10 pd-ltr-20">
    ...
    <div class="card-box pb-10">
      ...
      <div class="pd-20">
        <h4 class="text-blue h4">Register Users Data
        <a href="{{route('adduserpage')}}" class="btn btn-success btn-sm shadow-sm border-0  float-right">Add <span class="icon-copy ti-plus"></span></a>
        </h4>
...
{data: "phone_number", className: 'phone'},
{data: "company", className: 'company'},
