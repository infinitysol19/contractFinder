...
<div class="main-container">
  <div class="xs-pd-20-10 pd-ltr-20">
    ...
    <div class="card-box pb-10">
      ...
      <div class="pd-20">
        <h4 class="text-blue h4">Request Qoutes Data
...
ajax:{
url: "{{ route('req_qoutes_admin_ajax') }}",
data:{from_date:'ok'}
},
columns: [
{data: "id", className: 'id', orderable: true},
{data: "email", className: 'email',searchable:true},
{data: "link_to_tendor", className: 'link_to_tendor'},
{data: "tender_worth", className: 'tender_worth'},
{data: "tender_sector", className: 'tender_sector'},
