...
<div class="main-container">
  ...
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <a href="{{ route('add_subscriber_admin') }}" class="btn-success btn btn-sm shadow-lg border-0"> Add New Record</a>
  </div>
  <div class="card shadow mb-4">
    ...
    <div class="row">
      ...
      <div class="col-md-6">
          <button type="button" class="btn-block shadow-lg border-0 btn-success btn-sm sendmail" > Send Email To Subscribers</button>
        </div>
      ...
      <div class="table-responsive table-striped table mt-2" id="dataTable" role="grid" aria-describedby="dataTable_info">
        ...
        <table  class="checkbox-datatable table nowrap dataTable no-footer dtr-inline" >
          <thead>
            <tr>
               <th>Id</th>
              <th>Email</th>
...
if (willDelete) {
$.ajax({
url:"{{ route('delete_subscriber_admin_ajax') }}", 
type:"POST",
dataType:"json",
...
ajax:{
url: "{{ route('subscriber_admin_ajax') }}",
