  ...
  <div class="xs-pd-20-10 pd-ltr-20">
    ...
    <div class="card-box pb-10">
      ...
      <div class="pd-20">
        ...
        <a href="{{route('addcountrymockupview')}}" class="btn btn-success btn-sm shadow-sm border-0  float-right">Add <span class="icon-copy ti-plus"></span></a>
        </h4>
...
if (willDelete) {
$.ajax({
url:"{{ route('del_ajax_countrymockup') }}", 
type:"POST",
dataType:"json",
...
ajax:{
url: "{{ route('countrymockup_admin_ajax') }}",
data:{from_date:'ok'}
},
columns: [
