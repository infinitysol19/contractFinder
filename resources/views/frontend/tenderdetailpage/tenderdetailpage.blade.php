    ...
    <section class="product-details padding-bottom mt--240 mt-lg--440">
        ...
        <div class="container">
          ...
          <!--   <div class="product-details-slider-top-wrapper">
                ...
                <div class="product-details-slider owl-theme owl-carousel" id="sync1">
                    ...
                    <div class="slide-top-item">
                        ...
                        <div class="slide-inner">
                            ...
                            <img src="{{asset('frontend/images/product/product1.png')}}" alt="product">
                    ...
                    <div class="slide-top-item">
                        ...
                        <div class="slide-inner">
                            ...
                            <img src="{{asset('frontend/images/product/product2.png')}}" alt="product">
                    ...
                    <div class="slide-top-item">
                        ...
                        <div class="slide-inner">
                            ...
                            <img src="{{asset('frontend/images/product/product3.png')}}" alt="product">
                    ...
                    <div class="slide-top-item">
                        ...
                        <div class="slide-inner">
                            ...
                            <img src="{{asset('frontend/images/product/product4.png')}}" alt="product">
                    ...
                    <div class="slide-top-item">
                        ...
                        <div class="slide-inner">
                            ...
                            <img src="{{asset('frontend/images/product/product5.png')}}" alt="product">
                    ...
                    <div class="slide-top-item">
                        ...
                        <div class="slide-inner">
                            ...
                            <img src="{{asset('frontend/images/product/product6.png')}}" alt="product">
                ...
                <div class="product-bottom-slider owl-theme owl-carousel" id="sync2">
                    ...
                    <div class="slide-bottom-item">
                        ...
                        <div class="slide-inner">
                            ...
                            <img src="{{asset('frontend/images/product/01.png')}}" alt="product">
                    ...
                    <div class="slide-bottom-item">
                        ...
                        <div class="slide-inner">
                            ...
                            <img src="{{asset('frontend/images/product/02.png')}}" alt="product">
                    ...
                    <div class="slide-bottom-item">
                        ...
                        <div class="slide-inner">
                            ...
                            <img src="{{asset('frontend/images/product/03.png')}}" alt="product">
                    ...
                    <div class="slide-bottom-item">
                        ...
                        <div class="slide-inner">
                            ...
                            <img src="{{asset('frontend/images/product/04.png')}}" alt="product">
                    ...
                    <div class="slide-bottom-item">
                        ...
                        <div class="slide-inner">
                            ...
                            <img src="{{asset('frontend/images/product/05.png')}}" alt="product">
                    ...
                    <div class="slide-bottom-item">
                        ...
                        <div class="slide-inner">
                            ...
                            <img src="{{asset('frontend/images/product/06.png')}}" alt="product">
            ...
            <div class="row mt-40-60-80 bg-light ">

                <div class="col-lg-8 bg-light pt-5 pl-5 pb-5 product-detail-page-border-radius-1">

                    <div class="product-details-content">

                        <div class="product-details-header">

                            <h3 class="title text-uppercase">Work to Book of Remembrance Chapel and Skipton Town Hall</h3>
                        ...
                        <ul class="price-table mb-30">
                            ...
                            <li>
                             ...
                             <li>
                                ...
                                <h5 class="info">Yorkshire and the Humber</h5>

                            </li>

                            <li>

                                <span class="details">LOT: </span>

                                <h5 class="info">Single Lot</h5>

                            </li>

                             <li>

                                <span class="details">45000000: </span>

                                <h5 class="info">Construction work</h5>

                            </li>

                            <li>

                                <span class="details">AWARD CRITERIA: </span>

                                <h5 class="info">Not Specified</h5>
                        ...
                        <!-- <div class="product-bid-area">
                            ...
                            <form class="product-bid-form">
                                ...
                                <div class="search-icon">
                                    ...
                                    <img src="{{asset('frontend/images/product/search-icon.png')}}" alt="product">
                        ...
                        <div class="buy-now-area bg-red ">

                            <a href="#0" class="custom-button">View Portal</a>
                ...
                <div class="col-lg-4 bg-light pt-5 pr-5 pb-5">
                    ...
                    <!-- <div class="product-sidebar-area">
                     ...
                     <div class="auction-bidding product-detail-page">

                                <div class="d-flex justify-content-between"> 

                                    <span class="bid-title font-weight-normal text-uppercase mb-2 h5">Status
                                ...
                                <!-- <div class="countdown">
                                 ...
                                 <div class="bid-incr">
                                    ...
                                    <span class="text-dark font-weight-bold">Published : 15/7/2021</span><br>
                                    ...
                                    <span class="text-dark font-weight-bold">Closing : 5/8/2021</span><br>
                                 ...
                                 <!-- <div class="mt-3 mb-2 h5"> 

                                    <span class="bid-title font-weight-normal text-uppercase ">Publisher Details
                                ...
                                <a href="#0" class="custom-button mt-4 font-weight-bold"><i class="fas fa-eye h6 text-light"></i> Full Documentation</a>

                            </div>



                     <div class="auction-bidding product-detail-page mt-3">

                                <div class="d-flex justify-content-between"> 

                                    <span class="bid-title font-weight-normal text-uppercase mb-2 h5">Publisher details
                                ...
                                <!-- <div class="countdown">
                                 ...
                                 <div class="bid-incr">
                                    ...
                                    <span class="text-dark font-weight-bold">Craven District Council <span><br>
                                    ...
                                    <span class="text-dark font-weight-bold">1 Belle Vue Square, Broughton Road,
                                ...
                                <a href="#0" class="custom-button mt-4 font-weight-bold"><i class="fas fa-eye h6 text-light"></i> Buyer Info</a>
      ...
      <!--   <div class="product-tab-menu-area mb-40-60 mt-70-100"> -->
            ...
            <div class="container mb-40-60 mt-70-100 bg-light">

                <ul class="product-tab-menu nav nav-tabs">

                    <li>

                        <a href="#delevery" class="active" data-toggle="tab">
                    ...
                    <li>
                        ...
                        <a href="#details" data-toggle="tab">
                            ...
                            <div class="content">Find A Bid Writer</div>
                    ...
                    <li>
                        ...
                        <a href="#history" data-toggle="tab">
                            ...
                            <div class="content">Request Document</div>
                    ...
                    <li>
                        ...
                        <a href="#questions" data-toggle="tab">
                            ...
                            <div class="content">Tender Questions </div>
       ...
       <!--  </div> -->
        ...
        <div class="container bg-light p-5">
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane fade show active" id="delevery">
                    ...
                    <div class="shipping-wrapper">
                        ...
                        <div class="item">
                            ...
                            <p>As part of the project we require insulation to be installed in the roof void of the concert hall at Skipton Town Hall High Street, Skipton, BD23 1AH (approximate floor area 325m2). A Grade II listed building. Works to install Photovoltaic Panels will be undertaken by a Named Sub-Contractor.</p>

                            <p>The second part of the project is to re-roof the Book of Remembrance Chapel at Waltonwrays Cemetery, Carleton Road, Skipton, BD23 3BT. This re-roofing includes insulation and roof integrated solar photovoltaics and be in keeping with the historical nature of the Crematorium buildings.</p>
                                            ...
                                            <td data-history="bidder">
                                                ...
                                                <div class="user-info">
                                                    ...
                                                    <div class="thumb">
                                                        ...
                                                        <img src="{{asset('frontend/images/history/02.png')}}" alt="history">
                                            ...
                                            <td data-history="bidder">
                                                ...
                                                <div class="user-info">
                                                    ...
                                                    <div class="thumb">
                                                        ...
                                                        <img src="{{asset('frontend/images/history/03.png')}}" alt="history">
                                            ...
                                            <td data-history="bidder">
                                                ...
                                                <div class="user-info">
                                                    ...
                                                    <div class="thumb">
                                                        ...
                                                        <img src="{{asset('frontend/images/history/04.png')}}" alt="history">
                                            ...
                                            <td data-history="bidder">
                                                ...
                                                <div class="user-info">
                                                    ...
                                                    <div class="thumb">
                                                        ...
                                                        <img src="{{asset('frontend/images/history/05.png')}}" alt="history">
                        ...
                        <div class="faq-wrapper">
                            ...
                            <div class="faq-item">
                                ...
                                <div class="faq-title">
                                    ...
                                    <img src="{{asset('frontend/css/img/faq.png')}}" alt="css"><span class="title">How to start bidding?</span><span class="right-icon"></span>
                            ...
                            <div class="faq-item">
                                ...
                                <div class="faq-title">
                                    ...
                                    <img src="{{asset('frontend/css/img/faq.png')}}" alt="css"><span class="title">Security Deposit / Bidding Power </span><span class="right-icon"></span>
                            ...
                            <div class="faq-item">
                                ...
                                <div class="faq-title">
                                    ...
                                    <img src="{{asset('frontend/css/img/faq.png')}}" alt="css"><span class="title">Delivery time to the destination port </span><span class="right-icon"></span>
                            ...
                            <div class="faq-item">
                                ...
                                <div class="faq-title">
                                    ...
                                    <img src="{{asset('frontend/css/img/faq.png')}}" alt="css"><span class="title">How to register to bid in an auction?</span><span class="right-icon"></span>
                            ...
                            <div class="faq-item open active">
                                ...
                                <div class="faq-title">
                                    ...
                                    <img src="{{asset('frontend/css/img/faq.png')}}" alt="css"><span class="title">How will I know if my bid was successful?</span><span class="right-icon"></span>
                            ...
                            <div class="faq-item">
                                ...
                                <div class="faq-title">
                                    ...
                                    <img src="{{asset('frontend/css/img/faq.png')}}" alt="css"><span class="title">What happens if I bid on the wrong lot?</span><span class="right-icon"></span>
